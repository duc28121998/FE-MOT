...
const Thacmac = ({
  ...
  return (
    <DivThacMacMobile>
      <div className="mobile-thacmac">
        <Row className="mobile-thacmac__title">
          <Col className="mobile-thacmac__banhoi" xs={{ span: 24, offset: 0 }}>
            <h1>bạn hỏi</h1>
          </Col>
          <Col
            className="mobile-thacmac__rectangle"
            xs={{ span: 6, offset: 0 }}
          ></Col>
          <Col className="mobile-thacmac__mot" xs={{ span: 24, offset: 0 }}>
        ...
        <div>
          ...
          >
            <DivPanel
              ...
              key="1"
            >
              <Row className="mobile-thacmac__inlist ">
                <Col
                  className="mobile-thacmac__inlist-mot"
                  xs={{ span: 24, offset: 0 }}
                >
                  <h4>giày</h4>
                </Col>
                <Col
                  className="mobile-thacmac__inlist-hai"
                  xs={{ span: 22, offset: 2 }}
                >
                  <h4>Đời mới / Đời thường ?</h4>
                </Col>
                <Col
                  className="mobile-thacmac__inlist-ba "
                  xs={{ span: 22, offset: 2 }}
                >
                  <p>
            ...
            <DivPanel active={active.includes('6')} header="liên hệ" key="6">
              <Row className="mobile-thacmac__inlist ">
                ...
                >
                  ...
                  <h3 className="mobile-thacmac__inlist-lienhe">0774164406</h3>
                </Col>
              </Row>
              ...
              <Row className="mobile-thacmac__inlist ">
                ...
                >
                  ...
                  <h3 className="mobile-thacmac__inlist-lienhe">
